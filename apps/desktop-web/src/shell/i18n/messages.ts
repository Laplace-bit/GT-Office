...
export const messages = {
  ...
  'settingsModal.about.section.identity.title': { 'zh-CN': '应用信息', 'en-US': 'Application' },
  'settingsModal.about.section.identity.description': {
    'zh-CN': '当前安装包与产品标识。',
    'en-US': 'Package identity for the current build.',
  },
  'settingsModal.about.section.footprint.title': { 'zh-CN': '配置与数据', 'en-US': 'Configuration' },
  'settingsModal.about.section.footprint.description': {
    'zh-CN': '设置存储位置与安全边界。',
    'en-US': 'Where GT Office stores configuration and how secrets are handled.',
  },
  'settingsModal.about.section.runtime.title': { 'zh-CN': '运行时', 'en-US': 'Runtime' },
  'settingsModal.about.section.runtime.description': {
    'zh-CN': '当前会话所在的运行环境信息。',
    'en-US': 'Environment information for the current session.',
  },
  'settingsModal.about.item.name': { 'zh-CN': '名称', 'en-US': 'Name' },
  'settingsModal.about.item.version': { 'zh-CN': '版本', 'en-US': 'Version' },
  'settingsModal.about.item.identifier': { 'zh-CN': '标识符', 'en-US': 'Identifier' },
  'settingsModal.about.item.workspaceConfig': {
    'zh-CN': '工作区配置',
    'en-US': 'Workspace config',
  },
  'settingsModal.about.item.userSettings': { 'zh-CN': '用户级设置', 'en-US': 'User settings' },
  'settingsModal.about.item.security': { 'zh-CN': '密钥存储', 'en-US': 'Secret storage' },
  'settingsModal.about.item.runtime': { 'zh-CN': '运行模式', 'en-US': 'Runtime mode' },
  'settingsModal.about.item.tauriVersion': { 'zh-CN': 'Tauri 版本', 'en-US': 'Tauri version' },
  'settingsModal.about.value.userSettingsManaged': {
    'zh-CN': '系统标准应用目录托管',
    'en-US': 'Managed in the system app data directory',
  },
  'settingsModal.about.value.securityVault': {
    'zh-CN': '使用系统凭证存储，不明文落盘',
    'en-US': 'Uses the system credential vault and never writes plaintext',
  },
  'settingsModal.about.runtime.desktop': { 'zh-CN': '桌面端（Tauri）', 'en-US': 'Desktop (Tauri)' },
  'settingsModal.about.runtime.webPreview': { 'zh-CN': 'Web 预览', 'en-US': 'Web Preview' },
  ...
  'aiConfig.services.targetWorkspace': { 'zh-CN': '目标工作区', 'en-US': 'Target workspace' },
  'aiConfig.services.targetWorkspaceUnknown': { 'zh-CN': '当前未识别', 'en-US': 'Unknown current workspace' },
  ...
  'aiConfig.services.runtime': { 'zh-CN': '运行形态', 'en-US': 'Runtime' },
  'aiConfig.services.runtimeSidecar': { 'zh-CN': 'Rust Sidecar', 'en-US': 'Rust sidecar' },
  'aiConfig.services.runtimeLegacyNode': { 'zh-CN': '旧版 Node MCP', 'en-US': 'Legacy Node MCP' },
  'aiConfig.services.runtimeMissing': { 'zh-CN': '未检测到', 'en-US': 'Not installed' },
  'aiConfig.services.mcpStateInstalled': { 'zh-CN': '已安装', 'en-US': 'Installed' },
  'aiConfig.services.mcpStatePreconfigured': { 'zh-CN': '已预配置，待 CLI', 'en-US': 'Preconfigured, waiting for CLI' },
  'aiConfig.services.mcpStateLegacyNode': { 'zh-CN': '旧版 Node，需迁移', 'en-US': 'Legacy Node, migration needed' },
  ...
  'aiConfig.services.mcpLegacyNote': {
    'zh-CN': '检测到旧版 Node MCP 配置。删除 Node 运行时前，请先迁移到 Rust sidecar，避免当前 Agent 的 MCP 入口失效。',
    'en-US': 'A legacy Node MCP config was detected. Migrate to the Rust sidecar before removing the Node runtime so this agent does not lose its MCP entry.',
  },
  'aiConfig.services.installMcpAction': { 'zh-CN': '安装 MCP 组件', 'en-US': 'Install MCP Component' },
  'aiConfig.services.uninstallMcpAction': { 'zh-CN': '卸载 MCP 组件', 'en-US': 'Uninstall MCP Component' },
  'aiConfig.services.uninstallingMcpAction': { 'zh-CN': '卸载中...', 'en-US': 'Uninstalling...' },
  'aiConfig.services.migrateMcpAction': { 'zh-CN': '迁移到 Rust Sidecar', 'en-US': 'Migrate to Rust Sidecar' },
  'aiConfig.services.migratingMcpAction': { 'zh-CN': '迁移中...', 'en-US': 'Migrating...' },
