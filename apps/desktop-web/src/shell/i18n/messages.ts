...
export const messages = {
  ...
  'designer.briefPlaceholder': {
    'zh-CN': '把你的想法写在这里。\n\n描述目标、参与者和关键流程。写完点工具栏的 Agent，让它帮你补全实体、契约和验收标准。',
    'en-US': 'Write your idea here.\n\nDescribe the goal, the actors and the key flows. Then hit Agent in the toolbar to fill in entities, contracts and acceptance criteria.',
  },
