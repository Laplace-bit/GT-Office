...
mod tests {
    use super::{
        ...
        sanitized_workspace_window_label, workspace_window_title,
        SurfaceDetachedCustomLayoutPayload, SurfaceDetachedStationPayload,
        SurfaceDetachedWindowQueryPayload,
    };
    use base64::Engine;
